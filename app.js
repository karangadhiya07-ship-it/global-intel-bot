...
function detectCategory(title) {
  ...
  if (t.includes("stock") || t.includes("market") || t.includes("fed") || t.includes("inflation") || t.includes("economy")) return "Finance";
  if (t.includes("ai") || t.includes("technology") || t.includes("openai")) return "AI News";
...
function detectRisk(title) {
  const t = title.toLowerCase();
  if (t.includes("war") || t.includes("crash") || t.includes("plunge") || t.includes("attack") || t.includes("warning") || t.includes("emergency")) return "High";
  if (t.includes("market") || t.includes("fed") || t.includes("bitcoin") || t.includes("inflation") || t.includes("ai")) return "Medium";
  return "Low";
}
...
function renderNews(items) {
  ...
  if (!items.length) {
    ...
    financeRisk.textContent = "Low";
    cryptoAlert.textContent = "Normal";
    aiWatch.textContent = "Monitoring";
    return;
  }
  ...
  cryptoAlert.textContent =
    items.some(i => i.category === "Crypto" && i.risk !== "Low")
    ? "High Alert"
    : "Normal";
