...
async function renderEarthquakes(){
  const el=document.getElementById("earthquakeList"); if(!el) return;
  try{
  ...
  }catch(e){html("earthquakeList","Earthquake feed unavailable.");}
}

async function renderWildfires(){
  const el=document.getElementById("wildfireList"); if(!el) return;
  try{
  ...
  }catch(e){html("wildfireList","Wildfire feed unavailable.");}
}

async function renderWeatherAlerts(){
  const el=document.getElementById("weatherAlertList"); if(!el) return;
  try{
  ...
  }catch(e){html("weatherAlertList","Weather alerts unavailable.");}
}
...
async function renderConflicts(){
  ...
  }catch(e){html("conflictList","Conflict feed unavailable.");}
}
...
async function renderCountries(){
  ...
  if(list){
    ...
    }catch(e){html("countryList","Countries unavailable.");}
  }
}

async function renderAdmin(){
  const el=document.getElementById("adminStatus"); if(!el) return;
  try{
  ...
  }catch(e){html("adminStatus","Admin status unavailable.");}
}
