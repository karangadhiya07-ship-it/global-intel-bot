...
export async function onRequestGet({ request }) {
  ...
  const { articles, errors, feedCount } = await loadFeeds(FEED_GROUPS.c, topic, { limitArticles: limit, limitFeeds: 36 });
  return sendNews(topic, articles, errors, { feedGroup: 'c', feedCount });
}
