...
export async function onRequestGet({ request }) {
  ...
  const { articles, errors, feedCount } = await loadFeeds(FEED_GROUPS.d, topic, { limitArticles: limit, limitFeeds: 36 });
  return sendNews(topic, articles, errors, { feedGroup: 'd', feedCount });
}
